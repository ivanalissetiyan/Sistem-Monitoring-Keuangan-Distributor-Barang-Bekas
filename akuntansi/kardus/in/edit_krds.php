...
<div class="card card-success">
	<div class="card-header">
		<h3 class="card-title">
			<i class="fa fa-edit"></i> Ubah Data Kardus</h3>
	</div>
	<form action="" method="post" enctype="multipart/form-data">
		<div class="card-body">

			<input type='hidden' class="form-control" name="id_krds" value="<?php echo $id_krds['id_krds']; ?>"
			 readonly/>
			...
			<div class="form-group row">
				...
				<div class="col-sm-4">
					<input type="date" class="form-control" id="tgl_brg" name="tgl_brg" value="<?php echo $data_cek['tgl_brg']; ?>"
					/>
				</div>
			</div>
